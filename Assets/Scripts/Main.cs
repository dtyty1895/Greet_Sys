...
public class Main : MonoBehaviour
{
    ...
    public GameObject Export_Manager;

    public GameObject drop_edit;
    public GameObject drop_plus;
    ...
    public void init_plus()
    {
        ...
        {
            dropdown_first.options.Add(new Dropdown.OptionData() { text = item });
        }
    }
    #endregion
    #region 添加文字
    ...
    public void UIManager()
    {
        ...
        if (Manager.Export == true)
        {
            Export_Manager.SetActive(true);
        }
        else
        {
            Export_Manager.SetActive(false);
        }
    }
    #endregion
}
