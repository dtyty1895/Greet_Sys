...
namespace TriLibCore.Samples
{
    ...
    public class LoadModelFromFilePickerSample : MonoBehaviour
    {
        ...
        public void LoadModel()
        {
            ...
            Debug.Log(assetLoaderFilePicker);
        }
        ...
        private void OnMaterialsLoad(AssetLoaderContext assetLoaderContext)
        {
            if (assetLoaderContext.RootGameObject != null)
            {
               ...
               // Animator an =  assetLoaderContext.RootGameObject.AddComponent<Animator>();
            }
            else
            {
        ...
        private void OnLoad(AssetLoaderContext assetLoaderContext )
        {
            ...
            _loadedGameObject.transform.position = new Vector3(0, 0, 1);
            print(_loadedGameObject.transform.position);

            //if (_loadedGameObject != null)
            //{
            //    Camera.main.FitToBounds(assetLoaderContext.RootGameObject, 0f);
            //}
        }
    }
}
